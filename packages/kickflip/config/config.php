...
return [
    ...
    'collections' => [
        CollectionConfig::make('zombies', extends: ExtendsInfo::make('layouts.blog', 'content'), path: 'posts', sort: [SortOption::custom('index')]),
        CollectionConfig::make('posts', url: 'blog', extends: ExtendsInfo::make('layouts.blog', 'content')),
    ],
